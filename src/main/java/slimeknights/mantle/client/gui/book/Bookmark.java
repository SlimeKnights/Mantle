...
public class Bookmark extends GuiButton {
  ...
  public Bookmark(BookmarkData data) {
  ...
  public void drawButton(Minecraft mc, int mouseX, int mouseY) {
    if(visible) {
      ...
      if (data.text != null && !data.text.isEmpty()) {
        TextDataRenderer.drawScaledString(mc.fontRendererObj, data.text, xPosition + width / 2 - mc.fontRendererObj.getStringWidth(data.text) / TEXT_SCALE / 2, yPosition + height / 2 - mc.fontRendererObj.FONT_HEIGHT / 2, 0xFFFFFFFF, true, TEXT_SCALE);
      }
