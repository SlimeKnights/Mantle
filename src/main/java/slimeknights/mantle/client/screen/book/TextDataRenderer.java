...
public class TextDataRenderer {
   ...
   */
  public static String drawText(MatrixStack matrixStack, int x, int y, int boxWidth, int boxHeight, List<TextData> data, int mouseX, int mouseY, FontRenderer fr, List<ITextComponent> tooltip) {
    String action = "";
    ...
    for (TextData item : data) {
      ...
      if (item.tooltips != null && item.tooltips.size() > 0) {
   ...
   */
  public static List<ITextProperties> splitTextComponentBySize(ITextComponent textComponent, int width, int height, FontRenderer fontRenderer, float scale) {
    return splitTextComponentBySize(textComponent, width, height, width, fontRenderer, scale);
  }
   ...
   * @param fontRenderer the font renderer to use
   */
  public static void drawTooltip(MatrixStack matrixStack, List<ITextComponent> textLines, int mouseX, int mouseY, FontRenderer fontRenderer) {
    GuiUtils.drawHoveringText(matrixStack, textLines, mouseX, mouseY, BookScreen.PAGE_WIDTH, BookScreen.PAGE_HEIGHT, BookScreen.PAGE_WIDTH, fontRenderer);
